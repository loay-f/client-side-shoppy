...
//     <>
//       <span
//         className="absolute left-0 top-0 z-10 w-full h-screen bg-black bg-opacity-50"
//         onClick={() => {
//           props.setSideCart(false);
//         }}
//       ></span>
//       <aside className="fixed right-0 z-10 top-0 h-screen w-1/4 xs:w-full bg-white px-4">
//         <div className="flex flex-row justify-between text-navy p-2 py-6">
...
//               />
//             </svg>
//             <p className="font-semibold">3 item</p>
//           </div>
//           <svg
//             xmlns="http://www.w3.org/2000/svg"
//             fill="none"
